...
<html>
    ...
    <body>
        ...
        <div class="container customform" style="height:640px; width:380px;float: centre; margin-top: 100px; background-color:white ">
            <img class="img-fluid d-block mx-auto" src="../images/logo.jpg" alt="" style="height:100px;width:100px;">  
            <form action="resetpassword.php" method="POST">
                <p>Old Password *: <br> <input type= "password" name="oldpassword" class="inp" ><br>
                <br><br>New Password *: <br> <input type= "password" name="newpassword" class="inp"><br>
                <br><br>Confirm Password *: <br> <input type= "password" name="confirmpassword" class="inp"><br>
                <br><br><input type="submit" value="Submit" name="sub" align:centre class="submit">
            </p></form>
        </div>
    </body>
</html>
